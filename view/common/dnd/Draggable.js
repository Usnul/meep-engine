...
export class Draggable {
    ...
    link() {
        ...
        el.addEventListener(DragEvents.DragExit, this.__eventHandlers.dragExit);
    ...
    unlink() {
        ...
        el.removeEventListener(DragEvents.DragExit, this.__eventHandlers.dragExit);
