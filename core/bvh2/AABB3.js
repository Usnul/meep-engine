...
import computeMortonCode from './Morton.js';
import Vector3, { v3_dot } from '../geom/Vector3.js';
import { _boxSurfaceArea2, intersectRay, intersectSegment } from "./AABB3Math.js";
 ...
 * @param {*} [thisArg]
 */
AABB3.prototype.traverseCorners = function (callback, thisArg) {
    const _x0 = this.x0;
    const _y0 = this.y0;
    const _z0 = this.z0;
    const _x1 = this.x1;
 ...
 */
AABB3.prototype.getCorners = function (result) {
    const _x0 = this.x0;
    const _y0 = this.y0;
    const _z0 = this.z0;
    const _x1 = this.x1;
