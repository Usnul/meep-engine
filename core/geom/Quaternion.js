...
import Vector3, { v3_dot } from './Vector3.js';
import Signal from "../events/signal/Signal.js";
import { Matrix4 as ThreeMatrix4 } from 'three';
import { assert } from "../assert.js";
import { clamp, copysign, EPSILON, epsilonEquals, lerp, PI2, PI_HALF } from "../math/MathUtils.js";
...
class Quaternion {
    ...
    lookRotation_2(forwardVector) {
        ...
        createFromAxisAngle(rotAxis, rotAngle, this);
