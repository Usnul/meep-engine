...
import { gameBinarySerializationRegistry } from "../../../../model/game/GameBinarySerializationRegistry.js";
 ...
 * @returns {Task}
 */
function deserializeTask(numSerializedTypes, buffer, engine, dataset) {
    ...
    const registry = gameBinarySerializationRegistry;
 ...
 * @returns {Task}
 */
BinaryBufferDeSerializer.prototype.process = function (buffer, engine, dataset) {
    ...
    if (numSerializedTypes === 0) {
        ...
        task = deserializeTask(numSerializedTypes, buffer, engine, dataset);
    }
