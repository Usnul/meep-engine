 ...
 * @return {boolean}
 */
EntityComponentDataset.prototype.isComponentTypeRegistered = function (type) {
 ...
 */
EntityComponentDataset.prototype.registerComponentType = function (type) {
 ...
 * @returns {boolean}
 */
EntityComponentDataset.prototype.unregisterComponentType = function (type) {
    if (this.isComponentTypeRegistered(type)) {
        //not registered
        return false;
    }
 ...
 */
EntityComponentDataset.prototype.getAnyComponent = function (componentType) {
    let entity = -1;
    let component = null;
 ...
 * @param {*} [thisArg]
 */
EntityComponentDataset.prototype.addEntityEventListener = function (entity, eventName, listener, thisArg) {
 ...
 * @returns {boolean}
 */
EntityComponentDataset.prototype.removeEntityEventListener = function (entity, eventName, listener, thisArg) {
    const evl = this.__entityEventListeners;
