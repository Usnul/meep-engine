import { MonteCarloTreeSearch } from "./MonteCarlo.js";
import { StateType } from "./StateNode.js";
...
test("Simulator initialization", () => {
    ...
    function expand(s) {
        if (s < 3) {
            return [MoveEdge.fromFunction(incrementVector1)];
        }
    }
...
test("10 steps through tic-tac-toe terminates", () => {
    ...
    const expand = jest.fn(function (s) {
        ...
        s.traverseEmpty(index => {
            const edge = MoveEdge.fromFunction(s => {
