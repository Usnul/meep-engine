...
export const glslm_snoise = FunctionModule.from({
    id: 'glsl-noise/simplex/3d#snoise',
    ...
    dependencies: [
        FunctionModuleReference.from(
            'glsl-noise/simplex/3d#taylorInvSqrt',
        ...
        FunctionModuleReference.from(
            'glsl-noise/simplex/3d#mod289_v3',
            FunctionSignature.from(
                [
                    FunctionParameterSpecification.from(PortDirection.In, ParticleDataTypes.Vector3)
                ],
