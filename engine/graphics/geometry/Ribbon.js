 ...
 * @param {number} z
 */
Quad.prototype.setAttributePosition = function (index, x, y, z) {
...
Quad.prototype.setVertexA = function (x, y, z) {
    this.setAttributePosition(this.getA(), x, y, z);
};
Quad.prototype.setVertexB = function (x, y, z) {
    this.setAttributePosition(this.getB(), x, y, z);
};
Quad.prototype.setVertexC = function (x, y, z) {
    this.setAttributePosition(this.getC(), x, y, z);
};
Quad.prototype.setVertexD = function (x, y, z) {
