 ...
 * @param [thisArg]
 */
RenderLayer.prototype.computeNearFarClippingPlanes = function (frustum, near, far, callback, thisArg) {
 ...
 */
RenderLayer.prototype.buildVisibleSet = function (frustums, filters, callback, callbackContext) {
